...
let preloaderScene = new PreloaderScene({
    ...
    pack:{
        files: [
            { type:"spritesheet", key:Resources.Sprites.UI.ProgressBars.GreenSimple, url:"assets/sprites/ui/progressBars/greenProgressBarSimple.png", frameConfig:{frameWidth:10, frameHeight:10}},
        ]
    }
});
