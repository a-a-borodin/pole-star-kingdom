...
class MenuScene extends Phaser.Scene {
    ...
    create() {
        ...
        let inventoryLayer = this.add.container(this.buttonsLayer.x + this.buttonsLayer.width + container.width / 6, 0);
        inventoryLayer.setSize(container.width - inventoryLayer.x, container.height);
        container.add(inventoryLayer);

        let inventoryLayerPanel = this.add.image(0, 0, Resources.Sprites.UI.Panels.PanelBlack)
            .setOrigin(0)
            .setDisplaySize(inventoryLayer.width, inventoryLayer.height)
            .setAlpha(0.65);
        inventoryLayer.add(inventoryLayerPanel);


        this.inventoryButtonsLayer = this.add.container(0, 0)
            .setSize(inventoryLayer.width, inventoryLayer.height / 6);
        inventoryLayer.add(this.inventoryButtonsLayer);
        ...
        let inventoryElementsLayer = this.add.container(this.margin, this.inventoryButtonsLayer.y + this.inventoryButtonsLayer.height + this.margin);
        inventoryElementsLayer.setSize(inventoryLayer.width - this.margin, inventoryLayer.height - inventoryElementsLayer.y);
        inventoryLayer.add(inventoryElementsLayer);


        this.cellsLayer = this.add.container(0, 0);
        this.cellsLayer.setSize(inventoryElementsLayer.width / 2, inventoryElementsLayer.height / 1.5);
        inventoryElementsLayer.add(this.cellsLayer);




        let coinsIcon = this.add.sprite(this.margin, this.cellsLayer.y + this.cellsLayer.height, Resources.Sprites.UI.Icons.StatisticIcons, 0);
        this.coinsText = this.textManager.createText(coinsIcon.x + coinsIcon.displayWidth / 1.5, coinsIcon.y, this.player.getScore(), TextManager.SIMPLE, "25px").setOrigin(0, 0.5);
        ...
        this.equipmentLayer.setSize(inventoryElementsLayer.width - this.equipmentLayer.x, inventoryElementsLayer.height / 1.5);
        inventoryElementsLayer.add(this.equipmentLayer);

        this.initCells();

        this.statsLayer = this.add.container(this.equipmentLayer.x, this.equipmentLayer.y + this.equipmentLayer.height);
        this.statsLayer.setSize(inventoryElementsLayer.width - this.statsLayer.x, inventoryElementsLayer.height / 1.5);
        inventoryElementsLayer.add(this.statsLayer);
    ...
    initInventoryButtons() {
        ...
        this.bagButton.on("pointerup", fn);
        ...
        this.shopButton.on("pointerup", fn);
        ...
        this.storageButton.on("pointerup", fn);
        ...
        this.upgradesButton.on("pointerup", fn);
    ...
    initCells() {
        let cellClickFn = (cell) => {
            if (cell != undefined)
                return new InventoryDialogFrame(this, cell);
        };
        ...
        for (let v = 0; v < vrow; v++) {
            for (let h = 0; h < hrow; h++) {
                let cell = new CellContainer(this, x, y, cellWidth, cellHeight, padding, true, null);
                cell.onClick(() => {
